            ...
            <div className="relative z-10  sm:pb-16 md:pb-20 lg:max-w-2xl lg:w-full lg:pb-28 xl:pb-32">
                <main className="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
                    <div className="sm:text-center lg:text-left">
                        <h1 className="fade-in text-2xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-5xl xl:text-5xl">
                            <span className="block pt-9" >Power Your Productivity </span>
                            <span className="block text-slate-800">With KoveLaptops</span>
                        </h1>
